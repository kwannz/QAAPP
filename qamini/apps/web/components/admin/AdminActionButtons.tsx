        ...
        {primaryActions.map((action) => {
          ...
          return (
            <Button
              ...
              onClick={async () => handleAction(action)}
...
// 批量操作按钮组件
interface BatchActionButtonsProperties {
        ...
        {actions.map((action) => {
          ...
          return (
            <Button
              ...
              size="sm"
              className={action.className}
              onClick={async () => handleBatchAction(action)}
              disabled={disabled || Boolean(isProcessing)}
            >
              {isCurrentlyProcessing
? (
