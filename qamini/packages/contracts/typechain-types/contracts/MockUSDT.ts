...
export interface MockUSDTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "nextFaucetTime",
    values: [AddressLike]
  ): string;
...
export interface MockUSDT extends BaseContract {
  ...
  canUseFaucet: TypedContractMethod<[user: AddressLike], [boolean], "view">;
  ...
  nextFaucetTime: TypedContractMethod<[user: AddressLike], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "nextFaucetTime"
