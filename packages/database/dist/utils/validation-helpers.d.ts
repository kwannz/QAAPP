export declare function validateUserRole(role: string): boolean;
export declare function validateKycStatus(status: string): boolean;
export declare function validateOrderStatus(status: string): boolean;
export declare function validateUsdtAmount(amount: number): boolean;
export declare function validatePositionStatus(status: string): boolean;
export declare function validateCommissionType(type: string): boolean;
export declare function validateCommissionStatus(status: string): boolean;
