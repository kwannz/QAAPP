...
: (
  ...
  const renderCommissionManagement = () => {
    ...
    const pendingCommission = Number.parseFloat(formatUSDT(referralInfo.commissionEarned));
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1 bg-gray-50">
          <div className="container mx-auto py-8 px-4">
            ...
            <Tabs value="rules" onValueChange={() => {}} className="w-full">
...
// Loading component for when Web3 is not ready
function Web3LoadingPage() {
  return (
    <ProtectedRoute>
      <div className="flex min-h-screen flex-col">
        <Header />
        <main className="flex-1 bg-gray-50">
          <div className="container mx-auto py-8 px-4">
            ...
            {/* 简化版连接卡片，避免依赖 wagmi，在回退页也能显示CTA */}
            <Card className="mb-6">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Wallet className="h-5 w-5" />
...
// Temporary fallback component while Web3 integration is being stabilized
function ReferralPageFallback() {
  return (
    <ProtectedRoute>
      <div className="flex min-h-screen flex-col">
        <Header />
            ...
            <Card className="mb-6">
              ...
              <CardContent>
                <Alert className="mb-4 border-blue-200 bg-blue-50">
                  <Star className="h-4 w-4 text-blue-600" />
                  <AlertDescription className="text-blue-800">
                    <strong>功能升级通知：</strong>
                    推荐系统正在进行Web3集成优化，敬请期待！目前您可以：
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="font-semibold">推荐规则</h3>
                    </div>
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>• 成功推荐用户投资后，获得5%佣金奖励</li>
                      <li>• 佣金实时计算，无延迟</li>
                      <li>• 支持USDT和ETH投资产品</li>
                      <li>• 透明化链上记录，安全可靠</li>
                    </ul>
                  </div>
                </div>
...
// Main component - temporarily using fallback until Web3 integration is stabilized
