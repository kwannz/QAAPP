"use strict";exports.id=2492,exports.ids=[2492],exports.modules={92492:(a,b,c)=>{c.r(b),c.d(b,{AppKitModal:()=>aq,W3mModal:()=>ap,W3mModalBase:()=>ao});var d=c(8875),e=c(75230),f=c(22736),g=c(31046),h=c(47500),i=c(43912),j=c(33677),k=c(85015),l=c(4132),m=c(37171),n=c(57273);let o={isUnsupportedChainView:()=>"UnsupportedChain"===m.I.state.view||"SwitchNetwork"===m.I.state.view&&m.I.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView()||await n.U.isSIWXCloseDisabled())return void i.W.shake();i.W.close()}};var p=c(71697),q=c(39202),r=c(22797),s=c(53373),t=c(56019),u=c(6976);let v=(0,d.AH)`
  :host {
    display: block;
...
`,(0,d.qy)`
    ...
    `}};L.styles=[t.W5,t.fD,t.ck,J],K([(0,e.MZ)()],L.prototype,"size",void 0),K([(0,e.MZ)({type:Boolean})],L.prototype,"disabled",void 0),K([(0,e.MZ)()],L.prototype,"icon",void 0),K([(0,e.MZ)()],L.prototype,"iconColor",void 0),L=K([(0,u.E)("wui-icon-link")],L),c(29833),c(15181);let M=(0,d.AH)`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var N=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let O=class extends d.WF{constructor(){super(...arguments),this.imageSrc=""}render(){return(0,d.qy)`<button>
    ...
    ></wui-icon-box>`}};O.styles=[t.W5,t.fD,t.ck,M],N([(0,e.MZ)()],O.prototype,"imageSrc",void 0),O=N([(0,u.E)("wui-select")],O),c(64718),c(29532);var P=c(68875);let Q=(0,d.AH)`
  :host {
    height: 64px;
  }
...
`;var Z=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let $={loading:void 0,success:{backgroundColor:"success-100",iconColor:"success-100",icon:"checkmark"},error:{backgroundColor:"error-100",iconColor:"error-100",icon:"close"}},_=class extends d.WF{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=q.P.state.open,this.unsubscribe.push(q.P.subscribeKey("open",a=>{this.open=a,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(a=>a())}render(){let{message:a,variant:b,svg:c}=q.P.state,e=$[b],{icon:f,iconColor:g}=c??e??{};return(0,d.qy)`
      <wui-snackbar
        ...
        .loading=${"loading"===b}
      ></wui-snackbar>
    `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),q.P.state.autoClose&&(this.timeout=setTimeout(()=>q.P.hide(),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};_.styles=Y,Z([(0,e.wk)()],_.prototype,"open",void 0),_=Z([(0,s.EM)("w3m-snackbar")],_);var aa=c(27235),ab=c(52365),ac=c(49528);let ad=(0,aa.BX)({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ae=(0,ac.X)({state:ad,subscribe:a=>(0,aa.B1)(ad,()=>a(ad)),subscribeKey:(a,b)=>(0,ab.u$)(ad,a,b),showTooltip({message:a,triggerRect:b,variant:c}){ad.open=!0,ad.message=a,ad.triggerRect=b,ad.variant=c},hide(){ad.open=!1,ad.message="",ad.triggerRect={width:0,height:0,top:0,left:0}}});c(222);let af=(0,d.AH)`
  :host {
    pointer-events: none;
  }
