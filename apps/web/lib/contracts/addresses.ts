...
export function getContractAddresses(chainId: number) {
  switch (chainId) {
    ...
    default:
      return CONTRACTS.sepolia // 默认返回测试网
  }
}
...
export const PRODUCT_CONFIG = {
  [ProductType.SILVER]: {
    ...
    maxInvestment: 10000, // 10000 USDT (匹配合约)
    apr: 12, // 12% APR
  ...
  [ProductType.GOLD]: {
    ...
    maxInvestment: 50000, // 50000 USDT
    apr: 15, // 15% APR
  ...
  [ProductType.DIAMOND]: {
    ...
    maxInvestment: 200000, // 200000 USDT
    apr: 18, // 18% APR
  ...
  [ProductType.PLATINUM]: {
    ...
    minInvestment: 10000, // 10000 USDT
    maxInvestment: 500000, // 500000 USDT
    apr: 20, // 20% APR
    duration: 365, // 365天
