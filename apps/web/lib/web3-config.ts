...
export const supportedTokens = {
  USDT: {
    ...
    decimals: 6,
    addresses: {
      11155111: process.env.NEXT_PUBLIC_USDT_ADDRESS_SEPOLIA || '', // Sepolia 测试USDT
      31337: process.env.NEXT_PUBLIC_USDT_ADDRESS_LOCAL || '0x5FbDB2315678afecb367f032d93F642f64180aa3', // 本地测试USDT
    },
  },
  ETH: {
    name: 'Ethereum',
