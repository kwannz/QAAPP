...
import { PaginationQuery, QueryFilters } from '../../common/types/express.types';
export declare class CommissionsController {
    ...
    getUserCommissionHistory(userId: string, pagination: PaginationQuery): Promise<{
        data: ({
            id: string;
            userId: string;
            orderId: string;
    ...
    getAdminCommissionList(filters: QueryFilters): Promise<{
        data: ({
            id: string;
            userId: string;
            orderId: string;
