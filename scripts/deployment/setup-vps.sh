...
sudo -u postgres psql -c "CREATE USER qa_user WITH PASSWORD 'qa_password';"
...
# 创建系统服务用户
print_status "创建系统服务用户"
useradd -r -s /bin/false qaapp || true
usermod -a -G www-data qaapp || true
print_success "系统服务用户创建完成"

# 安装 SSL 证书工具 (Certbot)
print_status "安装 SSL 证书工具"
apt install -y certbot python3-certbot-nginx
print_success "SSL 证书工具安装完成"
...
echo ""
echo "🗄️ 数据库信息:"
echo "  - 数据库名: qa_database"
echo "  - 用户名: qa_user"
echo "  - 密码: qa_password"
echo "  - 端口: 5432"
echo ""
echo "📁 目录结构:"
echo "  - 应用目录: /var/www/qaapp"
echo "  - 日志目录: /var/log/qaapp"
echo ""
echo "🔥 下一步:"
echo "  1. 运行 deploy.sh 部署应用"
echo "  2. 配置域名和 SSL 证书"
echo "  3. 运行健康检查"
echo ""
